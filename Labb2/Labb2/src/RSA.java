...
public class RSA {
	...
	private String message = "Modular arithmetic is a special type of arithmetic that involves only integersModular arithmetic is a special type of arithmetic that involves only integers"
			+ "Modular arithmetic is a special type of arithmetic that involves only integersModular arithmetic is a special type of arithmetic that involves only integersModular arithmetic is a special type of arithmetic that involves only integers"
